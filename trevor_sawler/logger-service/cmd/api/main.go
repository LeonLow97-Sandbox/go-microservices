...
const (
	webPort  = "80" // change to another port for localhost
	rpcPort  = "5001"
	mongoURL = "mongodb://mongo:27017" // change `mongo` to `localhost`
	gRpcPort = "50001"
)
...
func (app *Config) rpcListen() error {
	...
	for {
		...
		// run rpc server in the background using GoRoutine
